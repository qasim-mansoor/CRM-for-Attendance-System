...
class AddRecordForm(forms.ModelForm):
    ...
    father_name = forms.CharField(widget=forms.widgets.TextInput(attrs={"placeholder":"Father Name", "class":"form-control"}), label="")
    ...
    emergency_number = forms.CharField(widget=forms.widgets.TextInput(attrs={"placeholder":"Emergency Number", "class":"form-control"}), label="")
    ...
    remarks = forms.CharField(widget=forms.widgets.Textarea(attrs={"placeholder":"Remarks", "class":"form-control"}), label="")
